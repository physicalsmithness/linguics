...
classes: [all-seats, all-authors]   # originates grammar + translation items; Rev 24 "what a seat ORIGINATES" test
project: Linguics
updated: 2026-08-12
waiting: parked
...
queue:
  - tier-2 review packet: NONE EXISTS for this seat (verified 2026-08-12 22:52); reported_speech absent from the 27-topic wave, likely by design (translation density 1.85 > 1.4 target)
  - answer_leak_dispatch section 5: DONE, 4 items -> multi_select, awaiting Architecture stamp   [thread, Next: Architecture]
  - (settled) batch disposition CLOSED v6; crit-13 + Rev-25 retrofits STAMPED
