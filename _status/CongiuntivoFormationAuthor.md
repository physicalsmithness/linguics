...
notes:
  ...
  - Correction on record: I initially reported 4 live false-credit bugs from a raw-substring audit that ignored existing per-phrase match_at; engine verification disproved it; no file change stands.
  - Wave 2 (imperfetto) DELIVERED 2026-07-18: 16 grammar (8 regular / 8 irregular) + 6 translation, authored natively at Rev 25. Verified on real engine: 16/16 correct credited, 48/48 guards reject, 59/59 whole-file regression, 0 unknown buckets. 9 accent defects (piu/cosi/gia) caught and fixed pre-delivery.
