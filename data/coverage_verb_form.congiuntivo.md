...
| 1 | 4 | fixed_concessive (C1) | frozen formulae. `che io sappia` stays as grammar (sappia appears once); costi quel che costi / sia come sia / vada come vada moved to translation — a repeating formula self-answers a free-text blank, so the whole-formula translation is the honest instrument (estate-net gate, 2026-08-03) |
