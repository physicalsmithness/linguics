...
**Update 2026-08-03 (item-shape convention, PENDING).** The estate-net gate found 8 no-change items in this batch (cue text == an accepted answer, so copying the cue scores): dem_questo_msg_01, dem_questo_trap_m_01, dem_quello_msg_simp_01/02/03, dem_pron_msg_01, dem_pron_questo_01, dem_pron_questo_neuter_01. Reacted (item_shape thread v5): demonstratives are class A (English 'this/that' fixes the lemma; classify against the paradigm). Fix, once Housing ships the clickable-English-cue and the grammar_engine :227 membership test, is subtractive: drop the Italian (quello)/(questo) cue uniformly and let the meaning-up-front gloss's 'this/that' be the clickable cue; pulls the 3 no-change pronoun items into the gloss too (supersedes live_round's 'leave pronouns unglossed' on those three). dem_questo_trap_m_01 is extra-motivated: its cue also gives away the Rev-27 problema.noun.gender co-credit. Nothing changed on disk yet (convention binds nobody until it closes).
